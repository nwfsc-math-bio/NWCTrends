...
df <- Status_trendfigure_multipanel_csv(esuname, pops.to.plot, ifit.total, ifit.fracwild, min.year=plot.min.year, max.year=plot.max.year)
...
coho.chum=any(metadat$Species %in% c("Coho", "Chum"))
...
if(output.type=="latex")
  print(xtable::xtable(a[[1]], align="rr|c|cccccc", digits=0), 
...
if(output.type=="latex"){
  cat("\\begin{landscape}")
  print(xtable::xtable(a[[1]], align="rr|c|cccccc", digits=0, caption=caption), 
...
if(output.type=="latex")
  print(xtable::xtable(a[[2]], align="rr|c|cccccc", digits=0), 
      comment=FALSE, include.rownames=FALSE, table.placement="p", type=output.type,
...
if(output.type=="latex"){
  cat("\\begin{landscape}")
  print(xtable::xtable(a[[2]], align="rr|c|cccccc", digits=0, caption=caption), 
      comment=FALSE, include.rownames=FALSE,
      caption.placement="top", table.placement="p", type=output.type) 
  cat("\\end{landscape}") }
if(output.type=="html"){
...
if(output.type=="latex")
  print(xtable::xtable(a, align="rr|ccccc", digits=2), 
      comment=FALSE, include.rownames=FALSE, table.placement="p", type=output.type,
...
if(output.type=="latex") 
  print(xtable::xtable(a, align="rr|ccccc", digits=2, caption=caption), 
      comment=FALSE, include.rownames=FALSE,
      caption.placement="top", table.placement="p", type=output.type)
if(output.type=="html"){
  cat("## Wild fracton\n\n")
...
nrange <- length(trend.table.control$year.ranges)
if(output.type=="latex")
  print(xtable::xtable(a, align=paste0("rr|c|",rep("c",nrange)), digits=2), 
      comment=FALSE, include.rownames=FALSE,
...
if(output.type=="latex")
  print(xtable::xtable(a, align=paste0("rr|c|",rep("c",nrange)), digits=2, caption=caption), 
      comment=FALSE, include.rownames=FALSE,
      caption.placement="top", table.placement="p", type=output.type)
if(output.type=="html"){
