...
if(output.type=="html"){
  ...
  cat(caption)
  clean.a = data.frame(lapply(a[[1]], function(x) {str_replace_all(x, "[)]", "\\\\)")} ))
  colnames(clean.a)=colnames(a[[2]])
  kable(clean.a) %>% kable_styling(full_width = FALSE)
}
```
...
if(output.type=="html"){
  ...
  cat(caption)
  clean.a = data.frame(lapply(a[[2]], function(x) {str_replace_all(x, "[)]", "\\\\)")} ))
  colnames(clean.a)=colnames(a[[2]])
  kable(clean.a) %>% kable_styling(full_width = FALSE)
}
```
