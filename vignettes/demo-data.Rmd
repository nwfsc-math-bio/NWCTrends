...
Example data files are in the "doc" folder of the installed package and in the "inst/doc" in the GitHub repository.

```{r demo, echo=FALSE}
fil <- system.file("doc", "demodata", "Demo_NWCTrends.csv", package="NWCTrends")
